      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-8 mt-4">
          ...
          <section className="space-y-4 text-sm leading-relaxed">
            <p>
              Sadguru Coaching Classes Coaching ("we", "us", "our") operates the Sadguru Coaching Classes mobile and web
            ...
            <p>
              Email: <a href="mailto:safarenglishkaprism@gmail.com" className="text-primary hover:underline">safarenglishkaprism@gmail.com</a>
            </p>
          </section>
        </Card>
      </div>
