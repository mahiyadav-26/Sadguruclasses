  ...
  public: {
    Tables: {
      ...
      landing_courses: {
        ...
        Relationships: [
          {
            foreignKeyName: "landing_courses_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "courses"
            referencedColumns: ["id"]
      ...
      lesson_quiz_markers: {
        ...
        Relationships: [
          {
            foreignKeyName: "lesson_quiz_markers_lesson_id_fkey"
            columns: ["lesson_id"]
            isOneToOne: false
            referencedRelation: "lessons"
            referencedColumns: ["id"]
      ...
      lessons: {
        Row: {
          ...
          auto_transcript_fetched_at: string | null
          auto_transcript_lang: string | null
          auto_transcript_status: string | null
          category: string | null
          chapter_id: string | null
    ...
    Functions: {
      ...
      admin_get_user_snapshot: { Args: { _user_id: string }; Returns: Json }
      admin_hide_content: {
        Args: {
          _content_id: string
      ...
      admin_mark_enrollment_legit: {
        Args: { _enrollment_id: number; _note: string }
        Returns: undefined
      }
      ...
      admin_revoke_enrollment: {
        Args: { _enrollment_id: number; _reason: string }
        Returns: undefined
      }
      ...
      can_access_storage_course: { Args: { path: string }; Returns: boolean }
      can_read_course_files: { Args: never; Returns: boolean }
      check_rate_limit: {
        Args: {
          _bucket: string
          _max: number
      ...
      get_course_bundle: { Args: { _course_id: number }; Returns: Json }
      ...
      process_refund:
        | { Args: { _razorpay_order_id: string }; Returns: undefined }
        | {
            Args: {
              _is_full?: boolean
              _razorpay_order_id: string
