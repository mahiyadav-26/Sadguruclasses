...
>(({ className, children, ...props }, ref) => {
  // Same body ref-count as Dialog so FABs stay hidden while an alert is open.
  React.useEffect(() => {
  ...
  return (
    <AlertDialogPortal>
      ...
      >
        ...
        <AlertDialogPrimitive.Description className="sr-only">Alert content</AlertDialogPrimitive.Description>
        {children}
      </AlertDialogPrimitive.Content>
    </AlertDialogPortal>
  );
