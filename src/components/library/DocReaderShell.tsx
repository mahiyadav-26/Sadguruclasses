...
export default function DocReaderShell({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex bg-background motion-safe:animate-in motion-safe:fade-in-0 motion-safe:duration-150" data-testid="doc-reader-shell">
      {/* Center column */}
