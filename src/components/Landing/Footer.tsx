              ...
              {[
                {
                  ...
                  label: "Chat on Sadguru Messenger",
                  icon: messengerIcon,
                },
                {
                  href: "https://t.me/sadgurucoachingclasses",
                  label: "Join Sadguru Broadcast",
                  icon: broadcastIcon,
                },
              ].map((s) => (
                <a
                  ...
                  className="h-11 w-11 rounded-2xl overflow-hidden bg-white/5 border border-white/10 hover:border-white/25 hover:scale-[1.05] transition-all flex items-center justify-center"
                  aria-label={s.label}
                  title={s.label}
                >
                  <img
