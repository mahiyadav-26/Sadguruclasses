...
<html lang="en">
  <head>
    ...
    <title>Sadguru Coaching Classes — Roz ka English practice</title>
    <meta name="description" content="Sadguru Coaching Classes — live classes, lessons aur doubts ek app me." />
  </head>
  <body>
    <div id="root"></div>
