...
${ctx || "(no lesson context provided)"}
      ...
      systemPrompt =
        "You are Safar AI Agent, a helpful teaching assistant for Sadguru Coaching Classes coaching. Answer the student's doubt clearly and concisely in Hindi or English based on the question language. Give step-by-step explanation if needed. Keep it under 500 words." +
        ragContext;
    }
