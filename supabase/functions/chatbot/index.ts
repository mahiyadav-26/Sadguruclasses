...
const CHATBOT_AI_MODEL = 'google/gemini-3.6-flash';
...
function resolveChatbotModel(rawModel?: string | null): string {
  ...
  if (/preview|gemini-3-flash|gemini-3\.5-flash|gemini-2\.5-flash|gemini-2\.0/i.test(model)) return CHATBOT_AI_MODEL;
