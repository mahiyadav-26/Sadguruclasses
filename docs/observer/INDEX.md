...
- [2026-07-13 post-CI-rename](2026-07-13-post-ci-rename.md) — after crash-shield MED fixes + build-apk.yml rename to SafarEnglish: MED-1 not re-verified, MED-2 has no regression test, tag guard untested, 7 named skills dropped this session.
...
- [2026-07-19 P1 ship loose ends](2026-07-19-p1-ship-loose-ends.md) — SEC migration + CI guards + LectureCard tokens shipped; open: get_course_lesson_stats P99 1.35s still, VIS/OBS ratchets untouched, player+Sentry parked on user input.
- [2026-07-20 session close (ship 1,2,3)](2026-07-20-session-close.md) — types current + SET_SAFE_AREA muted + dashboard sweep N/A; open: APK rebuild for FLAG_SECURE, get_course_lesson_stats prod benchmark, console→log migration, Sentry export.
- [2026-07-20 popup unification](2026-07-20-popup-unification.md) — shadcn Dialog/AlertDialog upgraded to Lovable look; FAB auto-hide via body attribute kills stray Safar "S" over Bookmark sheet; BookmarkNoteDialog chips retrofitted.
